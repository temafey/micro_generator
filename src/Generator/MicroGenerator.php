...
use MicroModule\MicroserviceGenerator\Generator\Exception\InvalidClassnameException;
use MicroModule\MicroserviceGenerator\Generator\Exception\InvalidMockTypeException;
use MicroModule\MicroserviceGenerator\Generator\Exception\MockNotExistsException;
 ...
 */
class MicroGenerator extends AbstractGenerator
{
    use CodeHelper;
    ...
    public function __construct(
        ...
        if (empty($className)) {
            $className = $inClassName . 'Test';
        }

        if (empty($sourceFile)) {
            $dirname = dirname($inSourceFile);
            $classNameTree = explode('\\', $className);
            $sourceFile = $dirname . DIRECTORY_SEPARATOR . end($classNameTree) . '.php';
        }
    ...
    public function generate(): ?string
    {
        ...
        $classTemplate->setVar(
            [
                ...
                'testBaseFullClassName' => trim($this->className['testBaseFullClassName'], '\\'),
